...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/tomoki/.rbenv/versions/2.3.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/tomoki/.rbenv/versions/2.3.1' '--with-openssl-dir=/usr/local/opt/openssl' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/tomoki/.rbenv/versions/2.3.1/lib ' 'CPPFLAGS=-I/Users/tomoki/.rbenv/versions/2.3.1/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/tomoki/.rbenv/versions/2.3.1"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/tomoki/.rbenv/versions/2.3.1/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/tomoki/.rbenv/versions/2.3.1/lib  -fstack-protector -L/usr/local/lib"
